...
<head>
	...
	<title>BDB - Motores y Ventiladores</title>
	...
	<div class="contenedor">
		<div class="fila centrado columnas">
			<div class="col-6 centroResponsive">
				<img src="img/BDB.png" class="imgdeProductoGrande">
			</div>
			<div class="col-4 alineacionDefault centroResponsive">
				<div class="contenedor">
				<div class="fila">
				<h3 class="tituloProductos col-12">BDB</h3>
				<h4 class="col-12">Línea OEM</h4>
				<p class="col-12">
					Serie BDB compuesta por ventiladores centrífugos de doble oído de aspiración y rodete de álabes atrasados, con 15 tamaños disponibles del 280 al 1400 de diámetro nominal.
