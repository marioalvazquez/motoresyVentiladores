...
<head>
	...
	<title>C-DA - Motores y Ventiladores</title>
	...
	<div class="contenedor">
		<div class="fila centrado columnas">
			...
			<div class="col-4 alineacionDefault centroResponsive">
				...
				<p class="col-12">
					Cajas de Ventilación Descarga Horizontal y Vertical.<br>
					Extracción de aire o ventilación de locales comerciales, salas de juntas, centros comerciales,
escuelas, etc. Inyección de aire para presurización de locales.
				</p>
