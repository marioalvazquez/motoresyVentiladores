...
<head>
	...
	<title>C-DAFV - Motores y Ventiladores</title>
...
<section>
	...
	<div class="contenedor">
		<div class="fila centrado">
			<div class="col-6">
				<img src="img/C-DAFV.png" class="imgdeProducto">
			</div>
			<div class="col-4 alineacionDefault">
				<div class="contenedor">
				<div class="fila">
				<h3 class="tituloProductos col-12">C-DAFV</h3>
				<h4 class="col-12">Unidades de Ventilación</h4>
				<p class="col-12">
					Cajas de Ventilación Descarga Vertical con Louvers y Prefiltros. Ventilación horizontal de locales comerciales o industriales con condiciones de pre-filtración. Filtros metálicos de aluminio y/o plisados. Inyección de aire en industria alimenticia, farmacéutica, etc.
				</p>
