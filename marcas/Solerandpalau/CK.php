...
<head>
	...
	<title>CK - Motores y Ventiladores</title>
	...
	<div class="contenedor">
		<div class="fila centrado columnas">
			<div class="col-6 centroResponsive">
				<img src="img/CK.png" class="imgdeProducto">
			</div>
			<div class="col-4 alineacionDefault centroResponsive">
				<div class="contenedor">
				<div class="fila">
				<h3 class="tituloProductos col-12">CK</h3>
				<h4 class="col-12">Línea Hábitat</h4>
				<p class="col-12">
						Extractores Centrífugos para Campana. Alto poder de extracción, facilidad de instalación, limpieza y mantenimiento, bajo consumo de energía, sólidos y compactos, recogedor de grasas. Campanas extractoras: cocinas domésticas, laboratorios, bares, cafeterías, etc.
				</p>
