	...
	<div class="contenedor">
		<div class="fila centrado columnas">
			<div class="col-6 centroResponsive">
				<img src="img/CWT.png" class="imgdeProductoGrande">
			</div>
			<div class="col-4 alineacionDefault centroResponsive">
				<div class="contenedor">
				<div class="fila">
				<h3 class="tituloProductos col-12">CWT</h3>
				<h4 class="col-12">Ventiladores Centrífugos Aplicación Industrial</h4>
				<p class="col-12">
					Equipos de
simple entrada, con tres tipos diferentes de rodetes impulsores, la línea CWT la transmisión de potencia se lleva a cabo por poleas y bandas.
