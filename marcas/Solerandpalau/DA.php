...
<head>
	...
	<title>DA - Motores y Ventiladores</title>
	...
	<div class="contenedor">
		<div class="fila centrado columnas">
			<div class="col-6 centroResponsive">
				<img src="img/DA.png" class="imgdeProducto">
			</div>
			<div class="col-4 alineacionDefault centroResponsive">
				<div class="contenedor">
				<div class="fila">
				<h3 class="tituloProductos col-12">DA</h3>
				<h4 class="col-12">Ventiladores de Alabes Curvos Adelantados</h4>
				<p class="col-12">
					Ventiladores Centrífugos Doble Aspiración. Diseño compacto.<br> Manejo de aire en sistemas de acondicionamiento de aire, ventilación
comercial, sistemas de manejadoras, manejadoras de filtración, aire lavado, etc.
				</p>
