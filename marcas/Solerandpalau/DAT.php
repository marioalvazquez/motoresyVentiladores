...
<head>
	...
	<title>DAT - Motores y Ventiladores</title>
	...
	<div class="contenedor">
		<div class="fila centrado columnas">
			<div class="col-6 centroResponsive">
				<img src="img/DAT.png" class="imgdeProducto">
			</div>
			<div class="col-4 alineacionDefault centroResponsive">
				<div class="contenedor">
				<div class="fila">
				<h3 class="tituloProductos col-12">DAT</h3>
				<h4 class="col-12">Ventiladores de Alabes Curvos Adelantados</h4>
				<p class="col-12">
					Ventiladores Centrífugos de Alabes Adelantados Tipo Twin. Diseño compacto para manejadoras de aire, procesos de filtración, ventilación general, etc.
				</p>
