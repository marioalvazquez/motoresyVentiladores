...
<head>
	...
	<title>LV - Motores y Ventiladores</title>
...
<section>
	...
	<div class="contenedor">
		<div class="fila centrado">
			<div class="col-6">
				<img src="img/LV.png" class="imgdeProducto">
			</div>
			<div class="col-4 alineacionDefault">
				<div class="contenedor">
				<div class="fila">
				<h3 class="tituloProductos col-12">LV</h3>
				<h4 class="col-12">Accesorios de Montaje para Equipos Axiales</h4>
				<p class="col-12">
					Totalmente construido en lámina galvanizada, recubrimiento en acabado aluminio matizado y marco de
sujeción exterior. Instalación en áreas para las cuales se necesita una libre entrada o salida de aire con un diseño
arquitectónicamente estético: Centros comerciales, naves industriales, bodegas, etc. Accesorio opcional: Malla mosquitero.
