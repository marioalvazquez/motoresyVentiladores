...
<head>
	...
	<title>RBC-W - Motores y Ventiladores</title>
	...
	<div class="contenedor">
		<div class="fila centrado columnas">
			<div class="col-6 centroResponsive">
				<img src="img/RBC-W.png" class="imgdeProducto">
			</div>
			<div class="col-4 alineacionDefault centroResponsive">
				<div class="contenedor">
				<div class="fila">
				<h3 class="tituloProductos col-12">RBC-W</h3>
				<h4 class="col-12">Tubulares</h4>
				<p class="col-12">
						Serie de equipos tuboaxiales para colocación en techo (RBC) o pared (RBW), compuesta por 4 opciones de tamaños: 400, 500, 630 y 800 mm. Termoplástico reforzado con fibra de vidrio que le confiere alta resistencia.
				</p>
