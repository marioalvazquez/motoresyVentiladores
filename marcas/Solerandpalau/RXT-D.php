...
<head>
	...
	<title>RXT-D - Motores y Ventiladores</title>
...
<section>
	...
	<div class="contenedor">
		<div class="fila centrado">
			<div class="col-6">
				<img src="img/RXT-D.png" class="imgdeProducto">
			</div>
			<div class="col-4 alineacionDefault">
				<div class="contenedor">
				<div class="fila">
				<h3 class="tituloProductos col-12">RXT-D</h3>
				<h4 class="col-12">Tejado Axiales</h4>
				<p class="col-12">
					Extractores Axiales con Compuerta. Extracción de aire en grandes cantidades, para industrias, bodegas, almacenes en general, estacionamientos, etc.
				</p>
