...
<head>
	...
	<title>SA - Motores y Ventiladores</title>
	...
	<div class="contenedor">
		<div class="fila centrado columnas">
			<div class="col-6 centroResponsive">
				<img src="img/SA.png" class="imgdeProductoGrande">
			</div>
			<div class="col-4 alineacionDefault centroResponsive">
				<div class="contenedor">
				<div class="fila">
				<h3 class="tituloProductos col-12">SA</h3>
				<h4 class="col-12">Ventiladores de Alabes Curvos Adelantados</h4>
				<p class="col-12">
					Ventiladores Centrífugos Simple Aspiración. Inyección de aire limpio en sistemas de ventilación, para centros comerciales, escuelas, bodegas, etc.
				</p>
