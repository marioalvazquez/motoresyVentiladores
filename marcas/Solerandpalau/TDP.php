...
<head>
	...
	<title>TDP - Motores y Ventiladores</title>
...
<section>
	...
	<div class="contenedor">
		<div class="fila centrado">
			<div class="col-6">
				<img src="img/TDP.png" class="imgdeProductoGrande">
			</div>
			<div class="col-4 alineacionDefault">
				<div class="contenedor">
				<div class="fila">
				<h3 class="tituloProductos col-12">TDP</h3>
				<h4 class="col-12">Línea Hábitat</h4>
				<p class="col-12">
					La gama TDP esta formada por dos
extractores TD montados en paralelo, esta disposición proporciona el doble del caudal y la misma presión que ofreciera un sólo equipo.
				</p>
