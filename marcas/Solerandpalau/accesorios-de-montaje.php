...
<head>
	...
	<title>Accesorios de Montaje - Motores y Ventiladores</title>
...
<section>
	...
	<div class="contenedor">
		<div class="fila centrado">
			<div class="col-6">
				<img src="img/ACCESORIOS-DE-MONTAJE.png" class="imgdeProductoGrande">
			</div>
			<div class="col-4 alineacionDefault">
				<div class="contenedor">
				<div class="fila">
				<h3 class="tituloProductos col-12">Accesorios de Montaje</h3>
				<h4 class="col-12">Accesorios de Montaje para Equipos Axiales</h4>
				<p class="col-12">
					(Galvanizado) Accesorios para realizar el montaje e instalación de equipos centrífugos de Tejado.
				</p>
