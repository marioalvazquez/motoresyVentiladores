...
<head>
	...
	<title>Accesorios para Control de Ruido y Vibración - Motores y Ventiladores</title>
	...
	<div class="contenedor">
		<div class="fila centrado columnas">
			<div class="col-6 centroResponsive">
				<img src="img/ACCESORIOS-RUIDO-VIBRACION.png" class="imgdeProducto">
			</div>
			<div class="col-4 alineacionDefault centroResponsive">
				<div class="contenedor">
				<div class="fila">
				<h3 class="tituloProductos col-12">Accesorios Ruido y Vibración</h3>
				<h4 class="col-12">Accesorios para Control de Ruido y Vibración</h4>
				<p class="col-12">
					Los resortes S&P, en sus 16 opciones, est.
