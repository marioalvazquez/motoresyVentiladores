...
<head>
	...
	<title>CAS - Motores y Ventiladores</title>
	...
	<div class="contenedor">
		<div class="fila centrado columnas">
			<div class="col-6 centroResponsive">
				<img src="img/CAS.png" class="imgdeProducto">
			</div>
			<div class="col-4 alineacionDefault centroResponsive">
				<div class="contenedor">
				<div class="fila">
				<h3 class="tituloProductos col-12">CAS</h3>
				<h4 class="col-12">Cortinas de Aire</h4>
				<p class="col-12">
					Las Cortinas de Aire CAS, ofrecen un
silencioso funcionamiento, ideal para aplicaciones
comerciales donde el nivel de ruido es fundamental;
envolvente diseñada y estilizada para optimizar la
salida de aire con velocidades apropiadas para su
uso en; oficinas, lavanderías, cafeterías, mini super,
farmacias, cuartos de refrigeración, etc.
				</p>
