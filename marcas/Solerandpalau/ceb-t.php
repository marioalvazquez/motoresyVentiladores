...
<head>
	...
	<title>CEB-T - Motores y Ventiladores</title>
	...
	<div class="contenedor">
		<div class="fila centrado columnas">
			<div class="col-6 centroResponsive">
				<img src="img/CEB-t.png" class="imgdeProducto">
			</div>
			<div class="col-4 alineacionDefault centroResponsive">
				<div class="contenedor">
				<div class="fila">
				<h3 class="tituloProductos col-12">CEB-T</h3>
				<h4 class="col-12">Centrífugos</h4>
				<p class="col-12">
					Extractores Centrífugos de Alabes Curvos Adelantados 800, 1200, 2000, 2600, 4000, 5000, y 6000 m3/hr. Carcasa en acero electrosoldado, acabado en pintura en polvo poliéster horneada de gran resistencia a
la corrosión, boca de descarga en cuatro posiciones con brida opcional. Instalaciones en sistemas de ventilación, extracción, calefacción y acondicionamiento de aire. Impulsión de aire dentro de conductos, refrigeración de máquinas industriales, etc.
