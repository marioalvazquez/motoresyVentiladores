...
<head>
	...
	<title>CRH - Motores y Ventiladores</title>
	...
	<div class="contenedor">
		<div class="fila centrado columnas">
			<div class="col-6 centroResponsive">
				<img src="img/CRH.png" class="imgdeProducto">
			</div>
			<div class="col-4 alineacionDefault centroResponsive">
				<div class="contenedor">
				<div class="fila">
				<h3 class="tituloProductos col-12">CRH</h3>
				<h4 class="col-12">Céntrífugos de Tejado y Pared</h4>
				<p class="col-12">
					Extractores Centrífugos de Tejado Descarga Horizontal. 
<br><br>
Extractores de aire en 14 tamaños, diseñados para la extracción de aire limpio en centros comerciales, grandes superficies, bodegas, escuelas, centros
productivos, talleres, etc.
				</p>
