...
<head>
	...
	<title>CRW - Motores y Ventiladores</title>
...
<section>
	...
	<div class="contenedor">
		<div class="fila centrado">
			<div class="col-6">
				<img src="img/CRW.png" class="imgdeProducto">
			</div>
			<div class="col-4 alineacionDefault">
				<div class="contenedor">
				<div class="fila">
				<h3 class="tituloProductos col-12">CRW</h3>
				<h4 class="col-12">Centrífugos de Tejado y Pared</h4>
				<p class="col-12">
					Extractores Centrífugos de Pared. Extracción de aire en donde es necesaria la posición del ventilador de forma horizontal en pared.
				</p>
