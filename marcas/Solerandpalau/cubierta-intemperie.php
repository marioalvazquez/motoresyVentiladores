...
<head>
	...
	<title>Cubierta Intemperie - Motores y Ventiladores</title>
	...
	<div class="contenedor">
		<div class="fila centrado columnas">
			<div class="col-6 centroResponsive">
				<img src="img/CUBIERTA-INTEMPERIE.png" class="imgdeProducto">
			</div>
			<div class="col-4 alineacionDefault centroResponsive">
				<div class="contenedor">
				<div class="fila">
				<h3 class="tituloProductos col-12">Cubierta Intemperie</h3>
				<h4 class="col-12">ccesorios de Montaje para Equipos Axiales</h4>
				<p class="col-12">
					Accesorio fabricado en lámina galvanizada, especial para adaptarse a equipos axiales, en donde la
