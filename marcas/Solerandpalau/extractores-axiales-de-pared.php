...
<head>
	...
	<title>Extractores Axiales de Pared - Motores y Ventiladores</title>
	...
	<div class="contenedor">
		<div class="fila centrado columnas">
			<div class="col-6 centroResponsive">
				<img src="img/Extractores-axiales-de-pared.png" class="imgdeProducto">
			</div>
			<div class="col-4 alineacionDefault centroResponsive">
				<div class="contenedor">
				<div class="fila">
				<h3 class="tituloProductos col-12">Extractores Axiales de Pared</h3>
				<h4 class="col-12">Linea Comercial</h4>
				<p class="col-12">
