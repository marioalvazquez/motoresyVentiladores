...
<head>
	...
	<title>Filtros - Motores y Ventiladores</title>
	...
	<div class="contenedor">
		<div class="fila centrado columnas">
			<div class="col-6 centroResponsive">
				<img src="img/FILTROS.png" class="imgdeProducto">
			</div>
			<div class="col-4 alineacionDefault centroResponsive">
				<div class="contenedor">
				<div class="fila">
				<h3 class="tituloProductos col-12">Filtros</h3>
				<h4 class="col-12">Accesorios de Montaje para Equipos Centrífugos</h4>
				<p class="col-12">
					Diferentes Modelos de Filtros de Aire
				</p>
