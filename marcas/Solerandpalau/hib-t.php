...
<head>
	...
	<title>HIB-T - Motores y Ventiladores</title>
	...
	<div class="contenedor">
		<div class="fila centrado columnas">
			<div class="col-6 centroResponsive">
				<img src="img/HIB-T.png" class="imgdeProducto">
			</div>
			<div class="col-4 alineacionDefault centroResponsive">
				<div class="contenedor">
				<div class="fila">
				<h3 class="tituloProductos col-12">HIB-T</h3>
				<h4 class="col-12">Axiales con Transmisión</h4>
				<p class="col-12">
					Extractores Axiales 630, 800, 1000 y 1250 mm. de diámetro. Hélices en 6 alabes, alineadas y balanceadas según altos estándares normativos, marco embocadura con venturi en embutición para el óptimo desempeño del ventilador, caja cojinetes con rodamientos a bolas de alta calidad. Grandes almacenes y bodegas, industrias en general, invernaderos, salas de espectáculos, gimnasios.
