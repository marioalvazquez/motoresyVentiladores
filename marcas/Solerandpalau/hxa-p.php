...
<head>
	...
	<title>HXA-P - Motores y Ventiladores</title>
	...
	<div class="contenedor">
		<div class="fila centrado columnas">
			<div class="col-6 centroResponsive">
				<img src="img/HXA-P.png" class="imgdeProductoGrande">
			</div>
			<div class="col-4 alineacionDefault centroResponsive">
				<div class="contenedor">
				<div class="fila">
				<h3 class="tituloProductos col-12">HXA-P</h3>
				<h4 class="col-12">Axiales Directos</h4>
				<p class="col-12">
					Extractores Axiales de Alta Eficiencia. Palas ajustables 800 y 1000 mm. de diámetro. Ventilación general para: Talleres, comercios, almacenes, locales industriales, estacionamientos, procesos de pintura industrial y en general.
