...
<head>
	...
	<title>HXM - Motores y Ventiladores</title>
...
<section>
	...
	<div class="contenedor">
		<div class="fila centrado">
			<div class="col-6">
				<img src="img/HXM.png" class="imgdeProductoGrande">
			</div>
			<div class="col-4 alineacionDefault">
				<div class="contenedor">
				<div class="fila">
				<h3 class="tituloProductos col-12">HXM</h3>
				<h4 class="col-12">Axiales Directos</h4>
				<p class="col-12">
					Extractores Axiales 200, 250 y 350 mm. de diámetro. Motor monofásico fraccionario, hélices con alineación y balanceo preciso, marco protector fabricado en lámina de acero y alambre pulido, acabado poliéster blanco horneado. Locales comerciales, bares, cafeterías, oficinas, salas de juntas, laboratorios, talleres, escuelas, etc.
