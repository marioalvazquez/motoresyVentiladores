...
<head>
	...
	<title>Porta Filtros - Motores y Ventiladores</title>
	...
	<div class="contenedor">
		<div class="fila centrado columnas">
			<div class="col-6 centroResponsive">
				<img src="img/PORTA-FILTROS.png" class="imgdeProducto">
			</div>
			<div class="col-4 alineacionDefault centroResponsive">
				<div class="contenedor">
				<div class="fila">
				<h3 class="tituloProductos col-12">Porta Filtros</h3>
				<h4 class="col-12">Accesorios de Montaje para Equipos Centrífugos</h4>
				<p class="col-12">
					Características Principales:<br><br>
-Diseño en lámina galvanizada calibres 18 y 20. -Puertas de acceso con bisagras.-Sellos internos, para evitar fugas futuras.<br>
-Aplicación para filtros tipo minipleat, carbón activado, plisado y lavable permanente de aluminio.
