...
<head>
	...
	<title>Silent - Motores y Ventiladores</title>
	...
	<div class="contenedor">
		<div class="fila centrado columnas">
			<div class="col-6 centroResponsive">
				<img src="img/SILENT.png" class="imgdeProductoGrande">
			</div>
			<div class="col-4 alineacionDefault centroResponsive">
				<div class="contenedor">
				<div class="fila">
				<h3 class="tituloProductos col-12">Silent</h3>
				<h4 class="col-12">Silent</h4>
				<p class="col-12">
