...
<head>
	...
	<title>Ventilador Axial con Domo para Techo - Motores y Ventiladores</title>
	...
	<div class="contenedor">
		<div class="fila centrado columnas">
			<div class="col-6 centroResponsive">
				<img src="img/DX.png" class="imgdeProductoGrande">
			</div>
			<div class="col-4 alineacionDefault centroResponsive">
				<div class="contenedor">
				<div class="fila">
				<h3 class="tituloProductos col-12">DX</h3>
				<h4 class="col-12">Ventilador Axial con Domo para Techo</h4>
				<p class="col-12">
					Ventilador Axial con Domo para Techo<br><br>
Unidades de ventilación diseñadas para la extracción e inyección de aire limpio. Están perfiladas para instalaciones de tejado, fabricadas en lámina galvanizada, esto con la finalidad de prevenir la corrosión.<br>
Esta serie cuenta con 2 opciones de transmisión; directa y poleas-bandas. <br>
Hélices de distintos materiales: aluminio, plástico y acero al carbón. <br>
